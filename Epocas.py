    ...
    def seccion_tres(self):
        ...
        with st.expander('Filtros'):
            ...
            def reporte_cambio_adquisicion(resultado):
                ...
                with col1:
                    fecha_inicio = st.date_input("Ingrese la fecha de inicio", datetime.date(fecha_minima.year, fecha_minima.month, fecha_minima.day), min_value=datetime.date(fecha_minima.year, fecha_minima.month, fecha_minima.day), max_value=datetime.date(fecha_maxima.year, fecha_maxima.month, fecha_maxima.day))
                    fecha_inicio = fecha_inicio.strftime("%Y-%m-%d")

                # Le pedimos al usuario seleccionar la fecha de fin del rango que usaremos
                with col2:
                    fecha_fin = st.date_input("Ingrese la fecha de fin", datetime.date(fecha_maxima.year, fecha_maxima.month, fecha_maxima.day), min_value=datetime.date(fecha_minima.year, fecha_minima.month, fecha_minima.day), max_value=datetime.date(fecha_maxima.year, fecha_maxima.month, fecha_maxima.day))
