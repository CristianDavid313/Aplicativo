...
class Principal:
        ...
        def rango_fechas(datos):
            ...
            with col2:
                opcion_dos = st.selectbox(
                    ...
                    index=len(año_fin['AÑO INSTALACION'].unique())-1,
                    key=2
                )
        ...
        def rango_fechas(datos):
            ...
            with col2:
                opcion_dos = st.selectbox(
                    ...
                    index=len(año_fin['AÑO RETIRO'].unique())-1,
                    key=4
                )
    ...
    def mapa(self):
        ...
        mapa = folium.Map(
            location=[4.609, -74.081],
            zoom_start=5
        )
        for row_index, row in datos.iterrows():

            if row['ESTADO'] == 'ACTIVA':
                color = 'green'
            elif row['ESTADO'] == 'RETIRADA':
                color = 'red'
            elif row['ESTADO'] == 'INACTIVA':
                color = 'gray'
            else:
                color = 'blue'
            ...
            folium.Marker(
                ...
                popup=(f'ESTACION:{row['IDENTIFICADOR']} ESTADO:{row['ESTADO']}'),
