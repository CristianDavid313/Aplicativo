...
def reporte(resultado, ruta):
    ...
    resultado.to_excel('Reportes/' + ruta, index=False, startrow=9)
    libro = openpyxl.load_workbook('Reportes/' + ruta)
    hoja = libro.active
